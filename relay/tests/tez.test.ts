...
describe("GET /tez/stream", () => {
  it("returns team tezits for a member", async () => {
    ...
    await shareTez(teamId, ADMIN_USER, { surfaceText: "First message", visibility: "team" });
    // Ensure the second message gets a strictly later timestamp
    await new Promise((r) => setTimeout(r, 10));
    await shareTez(teamId, MEMBER_USER, { surfaceText: "Second message", visibility: "team" });
