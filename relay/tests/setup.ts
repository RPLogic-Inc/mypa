...
const JWT_SECRET = process.env.JWT_SECRET || "relay-test-secret";
process.env.JWT_SECRET = JWT_SECRET;
process.env.JWT_ISSUER = process.env.JWT_ISSUER || "mypa";
process.env.JWT_AUDIENCE = process.env.JWT_AUDIENCE || "mypa-api";
process.env.RELAY_SYNC_TOKEN = process.env.RELAY_SYNC_TOKEN || "relay-sync-test-token";
